...
+
Informationen zur Ermittlung der ONTAP Zielversion finden Sie unter link:../ONTAP/choose-ontap-910-later.html["Vergleichen Sie ONTAP -Versionen, um die Vorteile und Risiken der Verwendung von Software-Updates zu verstehen"].

. Beheben und bestätigen Sie die ONTAP Blocker.
+
Informationen zur Behebung von Blockern finden Sie unter link:../ONTAP/fix-blockers-warnings.html["Beheben Sie alle Blocker mithilfe von Software-Updates vor einem ONTAP -Upgrade"].

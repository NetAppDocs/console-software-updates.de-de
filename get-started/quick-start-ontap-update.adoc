...
---
= Schnellstart zum Aktualisieren von ONTAP in Software-Updates
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
link:../ONTAP/validate-storage-system-update.html["Status eines ONTAP Updates in Software-Updates validieren"].
